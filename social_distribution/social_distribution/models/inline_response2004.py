...
class InlineResponse2004(Model):
    ...
    def __init__(self, query: str=None, success: bool=None, message: str=None):  # noqa: E501
        ...
        :param query: The query of this InlineResponse2004.  # noqa: E501
        :type query: str
    ...
    @property
    def query(self) -> str:
        """Gets the query of this InlineResponse2004.


        :return: The query of this InlineResponse2004.
        :rtype: str
        """
        return self._query
    ...
    def query(self, query: str):
        """Sets the query of this InlineResponse2004.


        :param query: The query of this InlineResponse2004.
        :type query: str
        """
