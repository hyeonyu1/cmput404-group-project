...
class ForeignServerRegisterForm(forms.ModelForm):
    ...
    foreign_server_hostname = forms.CharField(
        label="foreign_server_hostname", required=True, max_length=500, help_text="protocol should be stripped in this field. And No trailing /")
    ...
    foreign_server_api_location = forms.CharField(
        label="foreign_server_api_location", max_length=500, required=True, help_text="protocol should be stripped in this field. And No trailing /")
    ...
    password_registered_on_foreign_server = forms.CharField(
        label="password_registered_on_foreign_server", max_length=500, required=False, help_text="optional", widget=forms.PasswordInput)
