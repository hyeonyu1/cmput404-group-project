...
class TestPostsView(TestCase):
    ...
    def setUp(self):
        ...
        self.endpoints = {
            "service/posts": reverse('post_index'),
            "service/posts/{post_id}": reverse("post", )
        }

        self.client = Client(ACCEPTS="application/json")
    ...
    def test_posts_get_all_public_posts(self):
        """
        Test if service/posts will return all public posts
        :return:
        """
        endpoint = self.endpoints['service/posts']
