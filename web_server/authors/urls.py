...
urlpatterns = [
    # API URLS
    path('posts/', views.post_creation_and_retrival_to_curr_auth_user, name="add_or_get_post"),
    ...
    path('<str:author_id>/', views.retrieve_author_profile,name="author_profile"),
